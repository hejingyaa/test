dim_public_public_futu_au_user_channel_fact_df_sql="""
CREATE TABLE dim.public.public.futu_au_user_channel_fact_df(
...
dim_public_public_futu_au_user_identity_fact_df_sql="""
CREATE TABLE dim.public.public.futu_au.user_identity_fact_df(
...
from dws.t_portrait_20220928 a full outer join futu_au_au_user_web_account_setup_order b on a.uid=b.id
